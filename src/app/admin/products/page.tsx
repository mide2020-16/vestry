  ...
  return (
    <div className="max-w-4xl px-4 sm:px-0">
      ...
      <p className="text-neutral-400 mb-6 border-b border-neutral-800 pb-4 text-sm sm:text-base">
        Manage merch outfits, food, and drink options available during
        registration.
      </p>
      ...
      {message && (
        <div
          className={`fixed bottom-4 left-4 right-4 sm:static sm:mb-6 z-50 p-4 rounded-lg font-medium text-sm shadow-lg sm:shadow-none ${
          ...
          {Object.entries(CATEGORY_CONFIG).map(([cat, cfg]) => {
            ...
            return (
              ...
              >
                ...
                {cfg.label}
                <span
                  className={`text-xs px-1.5 py-0.5 rounded-full ${isActive ? "bg-white/10" : "bg-neutral-800"}`}
                >
