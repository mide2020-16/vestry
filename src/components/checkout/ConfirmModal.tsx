...
export function ConfirmModal({ isPaying, onConfirm, onCancel }: ConfirmModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 max-w-md w-full shadow-2xl">
        ...
        <p className="text-neutral-300 mb-6 leading-relaxed">
          ...
          <strong className="text-amber-400">Do not refresh or close the page</strong> while
